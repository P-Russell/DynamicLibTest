...
/*   Updated: 2018/07/03 06/50/59 by lde-jage         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Functions::Render(int8_t **arr)
{
	SDL_Rect rect;
	rect.h = BLOCK_SIZE;
	rect.w = BLOCK_SIZE;
...
extern "C" Functions * create()
{
	return new Functions();
}

extern "C" void destroy(Functions * func)
{
	delete func;
}
